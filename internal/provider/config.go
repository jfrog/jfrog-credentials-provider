...
func BackupConfig(isYaml bool, providerHome string, providerConfigFileName string, logs *logger.Logger) error {
...
func MergeConfig(dryRun, isYaml bool, providerHome string, providerConfigFileName string) {
	...
	if err := BackupConfig(isYaml, providerHome, providerConfigFileName, logs); err != nil {
