...
echo '{
  ...
  "env": [
    ...
    {
      "name": "aws_role_name",
      "value": "OperatorSelfManagedWorkerNodeRole"
    }
  ]
} 
...
export JFROG_CREDENTIAL_PROVIDER_BINARY_URL="https://eldada.jfrog.io/artifactory/public-local/jfrog_credentials_provider/jfrog-credential-provider-aws-linux"
